...
const WalletConfigInteractionButtons = ({ onClearFn, onDownloadFn }) => {
  ...
  return (
    <Grid container spacing={2}>
      <Grid item>
        <Button variant="contained" color="primary" onClick={onDownloadFn}>Download Wallet Details</Button>
      </Grid>
      <Grid item>
        <Button onClick={e => handleClearClick(e)} variant="contained" color="secondary">Clear Wallet</Button>
      </Grid>
    </Grid>
  )
}

...
function handleChangeAddressAndDust(newState, diff, outputTotalSats, finalUpdate) {
  let changeAmount;
...
function validateTransaction(state, finalUpdate) { // TODO: need less hacky way to supress error
  let newState = {...state};
  if (
